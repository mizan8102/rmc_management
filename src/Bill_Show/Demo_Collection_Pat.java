...
public class Demo_Collection_Pat extends javax.swing.JFrame {
  connection_class con;
  static  int top=1;
    public Demo_Collection_Pat(String text) {
        initComponents();
  ...
  initComponents();  }
    ...
    private void initComponents() {
        ...
        jLabel43.setBounds(470, 130, 100, 30);
        ...
        jLabel33.setBounds(470, 100, 100, 30);
        ...
        jLabel38.setBounds(470, 70, 100, 30);
        ...
        jLabel40.setBounds(470, 40, 100, 30);
        ...
        jPanel3.add(jPanel7);
        jPanel7.setBounds(600, -10, 30, 740);
        ...
        jScrollPane1.setBounds(0, 0, 770, 820);
        ...
        jPanel1.setBounds(0, 0, 820, 880);

        setSize(new java.awt.Dimension(822, 864));
...
void showData(String bill){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Demo_Collection_Pat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Demo_Collection_Pat().setVisible(true);
            }
        });
    }
